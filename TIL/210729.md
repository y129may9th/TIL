...
## ヘルスチェック
[ELBとRoute 53のヘルスチェック仕様の違い | DevelopersIO](https://dev.classmethod.jp/articles/health-check-spec-elb-route53/)
[ターゲットグループのヘルスチェック - Elastic Load Balancing ターゲットグループのヘルスチェック - Elastic Load Balancing](https://docs.aws.amazon.com/ja_jp/elasticloadbalancing/latest/application/target-group-health-checks.html)
